...
excerpt-img: /media/profiles/img/logos/arma2oa.jpg
author: Jason Hardin
...
categories:
  ...
  - fps
---
![Arma 2 Operation Arrowhead]({{site.url}}/media/profiles/img/logos/arma2oa.jpg){: .img-responsive  .center-block }
...
![Arma 2 Operation Arrowhead Logitech G13 M1 Keyboard Profile]({{site.url}}/media/profiles/img/arma_2_operation_arrowhead_m1_keyboard_layout.png){: .img-responsive  .center-block }
![Arma 2 Operation Arrowhead Logitech G13 M2 Keyboard Profile]({{site.url}}/media/profiles/img/arma_2_operation_arrowhead_m2_keyboard_layout.png){: .img-responsive  .center-block }
